...
namespace OnlineArticleCreator.Controllers
{
    ...
    {
        // Must hardcore project directory, since in .NET Core 2.2, Directory.GetCurrentDirectory()
        // doesn't do that.
        static string articleFolder = "D:/Documents/Github/OnlineArticleCreator" + 
            "/ArticleFiles/";
